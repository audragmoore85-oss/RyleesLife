...
export default function StatsBar({ entries }: StatsBarProps) {
  ...
  return (
    <div className="flex flex-wrap gap-3 justify-center">
      <div className="flex items-center gap-2 bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm rounded-xl px-4 py-2.5 shadow-sm border border-white/50 dark:border-slate-700/50">
        ...
        <div>
          <p className="text-xs text-slate-400 dark:text-slate-400 font-medium">Entries</p>
          <p className="text-lg font-bold text-slate-700 dark:text-slate-200 leading-none">{totalEntries}</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm rounded-xl px-4 py-2.5 shadow-sm border border-white/50 dark:border-slate-700/50">
        ...
        <div>
          <p className="text-xs text-slate-400 dark:text-slate-400 font-medium">Sharing with</p>
          <p className="text-lg font-bold text-slate-700 dark:text-slate-200 leading-none">Dad 💜</p>
        </div>
      </div>
      ...
      {topMoodConfig && (
        <div className="flex items-center gap-2 bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm rounded-xl px-4 py-2.5 shadow-sm border border-white/50 dark:border-slate-700/50">
          ...
          <div>
            <p className="text-xs text-slate-400 dark:text-slate-400 font-medium">Top mood</p>
